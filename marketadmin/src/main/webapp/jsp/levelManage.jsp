...
<head>
    ...
    <script type="text/javascript" charset="utf-8"
            src="${pageContext.request.contextPath}/js/levelManage.js"></script>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <script type="text/html" id="tools">
                    <a class="layui-btn layui-btn-xs" lay-event="updateLevel">修改</a>
                    <a class="layui-btn layui-btn-xs" lay-event="deleteLevel">删除</a>
                </script>
