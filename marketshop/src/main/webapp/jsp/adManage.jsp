            ...
            <div class="layui-card">
                <div class="layui-card-body ">
                    ...
                    <div class="layui-inline layui-show-xs-block">
                        <input type="text" name="title"  placeholder="请输入广告标题" autocomplete="off" class="layui-input" id="title">
                    </div>
                    <div class="layui-inline layui-show-xs-block">
                        <input type="text" name="goodName"  placeholder="请输入商品名" autocomplete="off" class="layui-input" id="goodName">
                    </div>
