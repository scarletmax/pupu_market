...
<head>
    ...
    <script type="text/javascript" charset="utf-8"
            src="${pageContext.request.contextPath}/js/couponManage.js"></script>
            ...
            <div class="layui-card">
                <div class="layui-card-body ">
                    <div class="layui-inline layui-show-xs-block">
                        <input type="text" name="name" placeholder="请输入优惠名称" autocomplete="off" class="layui-input"
                               id="name">
                    </div>
                    <div class="layui-inline layui-show-xs-block">
                        <input type="number" name="favor" min="0" placeholder="请输入优惠额度" autocomplete="off" class="layui-input"
                               id="favor">
                    </div>
