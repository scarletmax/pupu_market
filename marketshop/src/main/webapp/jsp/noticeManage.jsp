...
<head>
    ...
    <script type="text/javascript" charset="utf-8"
            src="${pageContext.request.contextPath}/js/noticeManage.js"></script>
            ...
            <div class="layui-card">
                <div class="layui-card-body ">
                    <div class="layui-inline layui-show-xs-block">
                        <input type="text" name="name" placeholder="推送标题" autocomplete="off" class="layui-input"
                               id="name">
                    </div>
                    <div class="layui-inline layui-show-xs-block">
                        <input  class="layui-input"  autocomplete="off" placeholder="推送开始时间" name="start" id="start">
                    </div>
                    <div class="layui-inline layui-show-xs-block">
                        <input class="layui-input"  autocomplete="off" placeholder="推送结束时间" name="end" id="end">
                    </div>
                ...
                <script type="text/html" id="tools">
                    {{#  if(d.stateStr =='待推送'){ }}
                    <a class="layui-btn layui-btn-xs" lay-event="noticeMsg">推送</a>
                    <a class="layui-btn layui-btn-xs" lay-event="updateMsg">修改</a>
                    <a class="layui-btn layui-btn-xs" lay-event="deleteMsg">删除</a>
                    {{# }if(d.stateStr =='已推送') { }}
                    <a class="layui-btn layui-btn-xs" lay-event="deleteMsg">删除</a>
                    {{# }if(d.stateStr =='已删除') { }}
                    {{#  } }}
